...
<div class="col-md-12 nopadding">
	<acf:Region id="reg_search" title="SEARCH" type="search">
 	...
 	<acf:Region id="reg_div_list" type="list" title="PAYMENT REQUEST LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="apcf002-search.ajax" readonly="true" autoLoad="false">
...
<!--   <acf:Region id="reg_form" title="PAYMENT REQUEST LIST">-->
			   		...
			   		<acf:Bind on="change"><script>
   						...
   						if (supplier_code == ""){
	   						...
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/apc/apcf002/apcf002-apc-get-supplier-name.ajax",
								data   : JSON.stringify({
	...
	<acf:Region id="payment_details" title="PAYMENT DETAILS" type="list">			
		<div class="col-md-12">
			<acf:Grid id="grid_paymentdetails" url="apcf002-get-paymentdetails-table.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
...
Controller.setOption({
    ...
    getUrl: "apcf002-get-form.ajax",
	saveUrl: "apcf002-save.ajax",
