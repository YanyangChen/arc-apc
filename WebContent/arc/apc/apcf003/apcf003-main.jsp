...
<acf:Region id="reg_list" title="LABOUR CONSUMPTION LIST" type="form">
	<div class="widget-main no-padding">
		<div class="col-md-12 form-padding">
			<acf:Grid id="grid_browse" url="apcf003-search.ajax" readonly="true">
...
<form id="frm_main" class="form-horizontal" data-role="form" >
	...
	<acf:Region id="reg_form" title="LABOUR CONSUMPTION MAINTENANCE OF COSTUME">
		<div class="form-group">		
	      				...
	      				<acf:Bind target="button" on="click"><script>
   						...
   						if ($.trim(programme_no) != ""){ 
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "apcf003-get-arc-programme.ajax",
								data   : JSON.stringify({
		...
		<div class="hidden">
			<input id="section_id" name="section_id" value="08"/>
 	...
 	<acf:Region id="consumption_details" title="LABOUR CONSUMPTION DETAILS" type="form">	
		...
		<div class="col-md-12 form-padding">			
			<acf:Grid id="grid_consume_dtl" url="apcf003-get-consume-dtl.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
					...
					<acf:Bind on="validate"><script>
						function validation (newValue, oldValue, newData, oldData, id) {
							...
							$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "apcf003-get-labour-type.ajax",
								data   : JSON.stringify({
...
Controller.setOption({
	...
	getUrl: "apcf003-get-form.ajax",
	saveUrl: "apcf003-save.ajax",
	...
	getSaveData: function() {
		...
		$("#grid_consume_dtl").pGrid$setHiddenValueForAllRecords("section_id", "08");
...
$(document).on('new clone', function() {
	$("#frm_main #programme_name").disable();
	$("#frm_main #chinese_programme_name").disable();
	$("#frm_main #busi_description").disable();
	$("#frm_main #dept_description").disable();
	...
	$.each($("#grid_consume_dtl").pGrid$getRecord(), function(id, rec){
		...
		if(rec.sequence_no) {
				...
				$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "apcf003-get-sub-section.ajax",
								data   : JSON.stringify({
								    'input_date'    : input_date,
