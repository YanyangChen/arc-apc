...
import arc.apc.Static.APCtGlobal;
import arc.apc.Static.APCtMapping;

@Controller
@Scope("session")
@ACFgFunction(id="APCF003")
@RequestMapping(value=APCtMapping.APCF003)
public class APCc003 extends ACFaAppController {
	...
	String section_id = APCtGlobal.APC_SECTION_ID;
	...
	private class Search extends ACFgSearch {
		public Search() {
			...
			setCustomSQL("select * from (select t1.process_date as process_date, t1.section_id as section_id, t1.programme_no as programme_no,  " +
	                 ...
	                 "  and t1.section_id = '"+APCtGlobal.APC_SECTION_ID+"')");			
	...
	@RequestMapping(value=APCtMapping.APCF003_MAIN, method=RequestMethod.GET)
	...
	@RequestMapping(value=APCtMapping.APCF003_SEARCH_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APCtMapping.APCF003_GET_FORM_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APCtMapping.APCF003_GET_CONSUME_DTL_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@ACFgTransaction
	@RequestMapping(value=APCtMapping.APCF003_SAVE_AJAX, method=RequestMethod.POST)
	@ResponseBody
    ...
    @RequestMapping(value=APCtMapping.APCF003_GET_ARC_PROGRAMME_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APCtMapping.APCF003_GET_LABOUR_TYPE_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APCtMapping.APCF003_GET_SUB_SECTION_AJAX, method=RequestMethod.POST)
    @ResponseBody
