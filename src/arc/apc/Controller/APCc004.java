...
@Controller
@Scope("session")
@ACFgFunction(id="APCF004")
@RequestMapping(value=APCtMapping.APCF004)
public class APCc004 extends ACFaAppController {
	...
	@RequestMapping(value=APCtMapping.APCF004_MAIN, method=RequestMethod.GET)
	...
	@RequestMapping(value=APCtMapping.APCF004_SEARCH_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APCtMapping.APCF004_GET_FORM_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APCtMapping.APCF004_GET_PAYMENT_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@ACFgTransaction
	@RequestMapping(value=APCtMapping.APCF004_SAVE_AJAX, method=RequestMethod.POST)
	@ResponseBody
    ...
    @RequestMapping(value=APCtMapping.APCF004_GET_SUPPLIER_AJAX, method=RequestMethod.POST)
    @ResponseBody
