...
@Scope("session")
@ACFgFunction(id="")
@RequestMapping(value=APCtMapping.APC) 
public class APCc extends ACFaAppController {
    ...
    public APCc() throws Exception {
        super();
    }
    
     
    
    @RequestMapping(value=APCtMapping.APC_PAYMENTDETAILS_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APCtMapping.APC_PROGRAMME_FIELDS_AJAX, method=RequestMethod.POST)
    @ResponseBody
...
//    
    @RequestMapping(value=APCtMapping.APC_BUSINESSPLATFORM_DESC_AJAX, method=RequestMethod.POST)
    @ResponseBody
