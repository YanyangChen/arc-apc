package arc.apc.Static;

public class APCtUtilityAndGlobal {

    /* constants used in ARC-APC Package */
    public final static String APC_IMAGES_PATH       = "/resource/img/";
    public final static String APC_IMAGES_URL        = "../img/";
    public final static String APC_TVB_LOGO_URL      = APC_IMAGES_URL + "slogo.png";
    public final static String APC_TVB_LOGO_PATH     = APC_IMAGES_PATH + "slogo.png";
    public final static String APC_END_OF_REPORT     = "*** END OF REPORT ***";
